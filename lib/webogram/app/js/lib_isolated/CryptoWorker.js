function CryptoWorker() {
    ...
    if (window.Worker) {
        var tmpWorker = new Worker('js/lib_isolated/crypto_worker.js')
    ...
    return {
        ...
        aesEncrypt: function (bytes, keyBytes, ivBytes) {
            ...
            return new Promise(resolve => {
                resolve(convertToArrayBuffer(aesEncryptSync(bytes, keyBytes, ivBytes)));
            })
        },
        aesDecrypt: function (encryptedBytes, keyBytes, ivBytes) {
            ...
            return new Promise(resolve => {
                resolve(convertToArrayBuffer(aesDecryptSync(encryptedBytes, keyBytes, ivBytes)));
            });
        },
        factorize: function (bytes) {
            ...
            return new Promise(resolve => {
                resolve(pqPrimeFactorization(bytes));
            });
        },
