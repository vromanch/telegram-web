...
function MtpApiFileManager(MtpApiManager, qSync, FileManager, MemoryFileStorage, WebpManager) {
            ...
            fileStorage.getFile(fileName, size).then(function (blob) {
                ...
                fileWriterPromise.then(function (fileWriter) {
                    ...
                    for (offset = startOffset; offset < size; offset += limit) {
                        ...
                        var newWriteFilePromise = new Promise(writeFileDeferredResolve => {
                            ...
                            writeFilePromise = newWriteFilePromise;
                        }); // writeFilePromise
                    }
                }); // fileWriterPromise
