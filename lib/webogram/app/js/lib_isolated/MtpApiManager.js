function MtpApiManager(Storage, MtpAuthorizer, MtpNetworkerFactory, MtpSingleInstanceService, AppRuntimeManager, ErrorService, qSync, WebPushApiManager, TelegramMeWebService) {
    ...
    // TODO (vserhiienko), looks like it's useless.
    ...
    function mtpSetUserAuth (dcID, userAuth) {
      ...
      var auth = new Event('user_auth', fullUserAuth);
      document.dispatchEvent(auth);
            ...
            function (error) {
              ...
              if (error.code == 401 && baseDcID == dcID) {
                ...
                if (cachedExportPromise[dcID] === undefined) {
                    ...
                    cachedExportPromise[dcID] = new Promise((resolve, reject) => {
