...
module.exports = function (config) {
  config.set({
    ...
    files: [
      {pattern: 'js/lib_isolated/polyfill.js', watched: false},
      {pattern: 'vendor/jquery/jquery.min.js', watched: false},
      {pattern: 'js/lib_isolated/config.js', watched: false},
      ...
      {pattern: 'js/lib_isolated/bin_utils.js', watched: false},
      {pattern: 'js/lib_isolated/tl_utils.js', watched: false},
      {pattern: 'js/lib/ng_utils.js', watched: false},
      {pattern: 'js/lib_isolated/i18n.js', watched: false},
